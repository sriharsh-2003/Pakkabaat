...
android {
    ...
    defaultConfig {
        ...
        buildConfigField("String", "BHASHINI_USER_ID", "\"${cfg("PAKKABAAT_BHASHINI_USER_ID")}\"")
        buildConfigField("String", "BHASHINI_API_KEY", "\"${cfg("PAKKABAAT_BHASHINI_API_KEY")}\"")
        buildConfigField("String", "BHASHINI_PIPELINE_ID", "\"${cfg("PAKKABAAT_BHASHINI_PIPELINE_ID")}\"")
...
dependencies {
    ...
    // Networking (Bhashini ASR + Gemini structuring LLM, both free-tier)
